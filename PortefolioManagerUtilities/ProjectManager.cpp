...
namespace PortefolioManagerUtilities {
	...
	QNetworkReply* ProjectManager::createProject(const QString& token, const QHash<QString, QString>& project)
	{
		...
		return NetworkManager::postUrlEncoded(QString("%1").arg(createProjectUrl), header, project);
	}
