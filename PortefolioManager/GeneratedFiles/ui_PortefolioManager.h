...
public:
    ...
    void setupUi(QMainWindow *PortefolioManagerClass)
    {
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/PortefolioManager/Resources/images/circular-arrow.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/PortefolioManager/Resources/images/bold-text-option.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/PortefolioManager/Resources/images/italic-text.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/PortefolioManager/Resources/images/underline-text-option.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/PortefolioManager/Resources/images/preview.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionTogglePreview->setIcon(icon5);
        actionToggleLog = new QAction(PortefolioManagerClass);
        actionToggleLog->setObjectName(QStringLiteral("actionToggleLog"));
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/PortefolioManager/Resources/images/log-file-format.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionToggleLog->setIcon(icon6);
        actionNewProject = new QAction(PortefolioManagerClass);
        actionNewProject->setObjectName(QStringLiteral("actionNewProject"));
        QIcon icon7;
        icon7.addFile(QStringLiteral(":/PortefolioManager/Resources/images/add-new-document.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon8;
        icon8.addFile(QStringLiteral(":/PortefolioManager/Resources/images/repairing-service.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionProjectSettings->setIcon(icon8);
